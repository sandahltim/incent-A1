...
function rainCoins() {
    try {
        if (typeof confetti !== 'undefined' && confetti) {
            // Enhanced confetti burst with multiple shots
            ...
            const interval = setInterval(function() {
                ...
                // Launch confetti from two points for better coverage
                confetti({
                    ...defaults,
                    particleCount,
...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    console.log('🎰 Slot machine and confetti systems initialized!');
